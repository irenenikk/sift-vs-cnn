...
class BaselineCNN(nn.Module):
    def __init__(self, maxpool_kernel_size=3, out1=8, kernel1=6, out2=20, kernel2=6, grey=False):
        ...
        self.pool1 = nn.MaxPool2d(maxpool_kernel_size, maxpool_kernel_size)
        self.conv2 = nn.Conv2d(out1, out2, kernel2)
        self.pool2 = nn.MaxPool2d(maxpool_kernel_size, maxpool_kernel_size)
    ...
    def forward(self, x):
        x = self.pool1(F.relu(self.bn2d(self.conv1(x))))

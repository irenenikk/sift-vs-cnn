...
if __name__ == '__main__':
    ...
    training_butterfly_dataloader = get_butterfly_dataloader(args.image_root, args.training_index_file, args.species_file, batch_size=args.batch_size, label_i=args.label_index, color_space=args.color_space)
    development_butterfly_dataloader = get_butterfly_dataloader(args.image_root, args.development_index_file, args.species_file, batch_size=args.batch_size, label_i=args.label_index, color_space=args.color_space)
